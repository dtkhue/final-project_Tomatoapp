...
filepath = 'C:/Users/QUE/Desktop/DATN - Tomato classification/model/GoogLeNet_tomatoclassification.h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:/Users/QUE/Desktop/DATN - Tomato classification/static/upload/', filename)
        file.save(file_path)
